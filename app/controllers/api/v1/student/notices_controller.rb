class Api::V1::Student::NoticesController < Api::V1::Student::StudentBaseController
  def index
  ...
  private
    def where_clause
      ...
      {_or: [{klass_id: current_section.klass_id, notice_type: 'Class Specific'}, {klass_id: current_section.klass_id, section_id: current_section.id}]}
    end
end
